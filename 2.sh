...
ip netns exec ns0 ip addr add 2001:2::4/64 dev vethns0
ip netns exec ns0 ip -6 route add ::/0 via 2001:2::3
ip netns exec ns0 ip addr add 10.0.2.4 dev vethns0
ip netns exec ns0 ip -6 route add 0.0.0.0/0 via 10.0.2.3
